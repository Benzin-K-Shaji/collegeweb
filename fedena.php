...
<body background="im44.jpg">
    <br><br><br>
   <div class="container">
       <div class="row">
           <div class="col"></div>
           <div class="col"> <table style="background-color: cornflowerblue;" class="table">
            <tr>
                <td>username</td><nav class="navbar navbar-expand-lg navbar-dark" style="background-color:green">
